<script lang="ts">
  let { 
    ...
    figCaption = 'Carbonatik Lithium Ion Anodes',
  ...
  let fullCompanyName = $derived(`${companyName} - Mining Operations`);
</script>
<section class="about-carbonatik">
  <figure>
    <img src={imgURL} alt={figCaption} class="imgPhoto" />
